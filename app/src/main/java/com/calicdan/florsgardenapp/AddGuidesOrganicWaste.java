        ...
        FirebaseDatabase.getInstance().getReference().child("Guides/OrganicWaste").push()
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void unused) {
                        Toast.makeText(AddGuidesOrganicWaste.this, "Data Inserted Successfully!", Toast.LENGTH_SHORT).show();
                    }
                })
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(AddGuidesOrganicWaste.this, "Error! Cannot Insert Data.", Toast.LENGTH_SHORT).show();
                    }
                });
    }
}