...
public class HowToAdapter extends FirebaseRecyclerAdapter<HomeModel,HowToAdapter.myViewHolder> {
    /**
     ...
     * @param options
     */
    public HowToAdapter(@NonNull FirebaseRecyclerOptions<HomeModel> options) {
        super(Objects.requireNonNull(options));
    }

    @Override
    protected void onBindViewHolder(@NonNull HowToAdapter.myViewHolder holder, @SuppressLint("RecyclerView") final int position, @NonNull HomeModel model) {
    ...
    @NonNull
    @Override
    public HowToAdapter.myViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.how_item,parent,false);
        return new HowToAdapter.myViewHolder(view);
