...
public class OrganicWasteAdapterUser extends FirebaseRecyclerAdapter<HomeModel,OrganicWasteAdapterUser.myViewHolder> {
    /**
     ...
     * @param options
     */
    public OrganicWasteAdapterUser(@NonNull FirebaseRecyclerOptions<HomeModel> options) {
            ...
            public void onClick(View v) {
                ...
                btnUpdate.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        FirebaseDatabase.getInstance().getReference().child("Guides/OrganicWaste")
...
*/
    ...
    @NonNull
    @Override
    public OrganicWasteAdapterUser.myViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.home_item_user,parent,false);
        return new OrganicWasteAdapterUser.myViewHolder(view);
