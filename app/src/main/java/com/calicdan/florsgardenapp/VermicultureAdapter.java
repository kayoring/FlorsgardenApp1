...
public class VermicultureAdapter extends FirebaseRecyclerAdapter<HomeModel,VermicultureAdapter.myViewHolder> {
    /**
     ...
     * @param options
     */
    public VermicultureAdapter(@NonNull FirebaseRecyclerOptions<HomeModel> options) {
        super(Objects.requireNonNull(options));
    }

    @Override
    protected void onBindViewHolder(@NonNull VermicultureAdapter.myViewHolder holder, @SuppressLint("RecyclerView") final int position, @NonNull HomeModel model) {
    ...
    public VermicultureAdapter.myViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new VermicultureAdapter.myViewHolder(view);
