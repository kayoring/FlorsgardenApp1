...
public class VermicultureAdapterUser extends FirebaseRecyclerAdapter<HomeModel, VermicultureAdapterUser.myViewHolder> {
    /**
     ...
     * @param options
     */
    public VermicultureAdapterUser(@NonNull FirebaseRecyclerOptions<HomeModel> options) {
        super(Objects.requireNonNull(options));
    }

    @Override
    protected void onBindViewHolder(@NonNull VermicultureAdapterUser.myViewHolder holder, @SuppressLint("RecyclerView") final int position, @NonNull HomeModel model) {
 ...
 */
    ...
    @NonNull
    @Override
    public VermicultureAdapterUser.myViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.home_item_user,parent,false);
        return new VermicultureAdapterUser.myViewHolder(view);
