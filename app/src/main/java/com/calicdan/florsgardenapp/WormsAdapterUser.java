...
public class WormsAdapterUser extends FirebaseRecyclerAdapter<HomeModel,WormsAdapterUser.myViewHolder> {
/**
 ...
 * @param options
 */
public WormsAdapterUser(@NonNull FirebaseRecyclerOptions<HomeModel> options) {
...
@NonNull
@Override
public WormsAdapterUser.myViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.home_item_user,parent,false);
        return new WormsAdapterUser.myViewHolder(view);
